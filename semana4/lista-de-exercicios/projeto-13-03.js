...
Basicamente, eles salvam o nome do clientes, o saldo total e uma lista contendo todas as compras realizadas pelo cliente. 
Veja abaixo:
const contas = [
...
const subtrairComprasDoSaldo = contas.forEach((cliente, index, array)=>{
    let compras = cliente.compras
    for(cadaCompra of compras){
       cliente.saldoTotal = cliente.saldoTotal - cadaCompra
    }  
})
